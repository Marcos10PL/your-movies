...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${fredoka.className} antialiased flex flex-col h-screen bg-gradient-to-b from-slate-500 to-slate-400 dark:from-slate-950 dark:to-black`}
      >
        <header>
          <Navbar />
        </header>
        ...
        <main className="flex flex-grow flex-col md:flex-row md:overflow-hidden">
          ...
          <section id="content" className="flex-grow md:overflow-y-auto scrollbar scrollbar-thumb-slate-600 scrollbar-track-slate-900">{children}</section>
        </main>
